...
uses
  ...
  FMX.Controls.Presentation, FMX.StdCtrls, FMX.TMSFNCCustomControl, JSON,
  FMX.TMSFNCPlannerBase, FMX.TMSFNCPlannerData, FMX.TMSFNCPlanner, FMX.TMSFNCCloudBase,
  FMX.TMSFNCCustomPicker, FMX.TMSFNCComboBox;
