...
uses
  ...
  FMX.StdCtrls, FMX.Layouts, FMX.ListBox, FMX.TMSFNCRichEditorToolBar,
  FMX.TMSFNCCustomControl, FMX.TMSFNCToolBar, FMX.TMSFNCTypes, FMX.TMSFNCUtils,
  FMX.TMSFNCCustomComponent, FMX.TMSFNCPDFIO, FMX.TMSFNCRichEditorPDFIO,
  FMX.Controls.Presentation, FMX.TMSFNCGraphics, FMX.TMSFNCGraphicsTypes,
  FMX.TMSFNCRichEditorRuler, FMX.Printer, FMX.TMSFNCPrintIO,
...
begin
  ...
  TMSFNCRichEditor1.SetSelectionColor(claGreen);

  TMSFNCRichEditor1.SelectText(25,4);
  TMSFNCRichEditor1.SetSelectionColor(clRed);
  TMSFNCRichEditor1.SetSelectionBkColor(claYellow);
