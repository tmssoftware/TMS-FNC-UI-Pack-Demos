...
uses
  ...
  FMX.Forms, FMX.TMSFNCRibbon, FMX.TMSFNCRichEditor, FMX.Types, FMX.Controls,
  ...
  FMX.TMSFNCScrollControl, FMX.TMSFNCRichEditorBase, FMX.TMSFNCPageControl,
  FMX.TMSFNCTabSet, FMX.TMSFNCHTMLText, FMX.TMSFNCToolBar,
  FMX.TMSFNCCustomControl, FMX.TMSFNCStatusBar;

type
  TForm130 = class(TTMSFNCRibbonForm)
    ...
    procedure TMSFNCRichEditor1KeyDown(Sender: TObject; var Key: Word;
...
procedure TForm130.TMSFNCRichEditor1KeyDown(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
  sb.Panels.Items[1].Text := 'Word count: ' + IntToStr(WordCount(re.Text));
end;
