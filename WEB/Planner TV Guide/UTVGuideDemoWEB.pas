unit UTVGuideDemoWEB;

interface

uses
  System.SysUtils, System.Classes, System.DateUtils, JS, Web, WEBLib.Graphics, WEBLib.Controls,
  WEBLib.Forms, WEBLib.Dialogs, WEBLib.JSON, Contnrs, VCL.TMSFNCTypes,
  VCL.TMSFNCUtils, VCL.TMSFNCGraphics, VCL.TMSFNCGraphicsTypes,
  VCL.TMSFNCPlannerBase, VCL.TMSFNCPlannerData, VCL.TMSFNCPlanner,
  VCL.TMSFNCCustomControl, VCL.TMSFNCCustomPicker, VCL.TMSFNCComboBox,
  Vcl.Controls, WEBLib.ExtCtrls, WEBLib.TMSFNCCloudBase, Vcl.StdCtrls,
  WEBLib.StdCtrls;
...
type
  ...
  TTVShows = class(TObjectList)
  private
     function GetItem(Index: Integer): TTVShow;
    procedure SetItem(Index: Integer; const Value: TTVShow);
  public
    property Items[Index: Integer]: TTVShow read GetItem write SetItem; default;
  end;
  ...
  TTVChannels = class(TObjectList)
  private
     function GetItem(Index: Integer): TTVChannel;
    procedure SetItem(Index: Integer; const Value: TTVChannel);
  public
    property Items[Index: Integer]: TTVChannel read GetItem write SetItem; default;
  end;
...
procedure TForm1.DoGetChannels(
...
begin
  ...
  lbl.Caption := 'TV Guide FNC Planner Demo';
...
function TTVChannels.GetItem(Index: Integer): TTVChannel;
begin
  Result := TTVChannel(inherited Items[Index]);
end;

procedure TTVChannels.SetItem(Index: Integer; const Value: TTVChannel);
begin
  inherited Items[Index] := Value;
end;

function TTVShows.GetItem(Index: Integer): TTVShow;
begin
  Result := TTVShow(inherited Items[Index]);
end;

procedure TTVShows.SetItem(Index: Integer; const Value: TTVShow);
begin
  inherited Items[Index] := Value;
end;
