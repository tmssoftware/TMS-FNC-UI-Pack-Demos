...
uses
  ...
  ExtCtrls, LCLTMSFNCGraphicsTypes, LCLTMSFNCCalendar, LCLTMSFNCDatePicker, LCLTMSFNCBitmapContainer, LCLTMSFNCTypes, LCLTMSFNCGraphics;
...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure TMSFNCCalendar1CustomNavigation(Sender: TObject; ADate: TDate; AFocusedDate: TDate; ADirection: Boolean);
    ...
    procedure TMSFNCCalendar1SelectMultiDate(Sender: TObject; AStartDate: TDate; AEndDate: TDate);
    ...
    procedure TMSFNCDatePicker1CustomNavigation(Sender: TObject; ADate: TDate; AFocusedDate: TDate; ADirection: Boolean);
...
procedure TForm1.TMSFNCCalendar1CustomNavigation(Sender: TObject; ADate: TDate;
...
procedure TForm1.TMSFNCCalendar1MonthChanged(Sender: TObject;
  AMonth: Integer);
begin
...
procedure TForm1.TMSFNCCalendar1SelectMultiDate(Sender: TObject;
...
procedure TForm1.TMSFNCCalendar1YearChanged(Sender: TObject; AYear: Integer);
begin
  TMSFNCDatePicker1.Year := TMSFNCCalendar1.Year;
end;

procedure TForm1.TMSFNCCalendar2CustomArrowDraw(Sender: TObject;
...
procedure TForm1.TMSFNCDatePicker1CustomNavigation(Sender: TObject;
  ADate: TDate; AFocusedDate: TDate; ADirection: Boolean);
begin
  if ADirection then
...
procedure TForm1.TMSFNCDatePicker1DateSelected(Sender: TObject; ADate: TDate);
begin
  ListBox1.Clear;
...
procedure TForm1.TMSFNCDatePicker1MonthChanged(Sender: TObject;
  AMonth: Integer);
begin
  TMSFNCCalendar1.Month := TMSFNCDatePicker1.Month;
end;

procedure TForm1.TMSFNCDatePicker1YearChanged(Sender: TObject;
  AYear: Integer);
begin
  TMSFNCCalendar1.Year := TMSFNCDatePicker1.Year;
end;

procedure TForm1.TMSFNCDatePicker2CustomArrowDraw(Sender: TObject;
  AGraphics: TTMSFNCGraphics; ARect: TRectF; ADirection: Boolean);
var
  pr, pl: TPointF;
  h, r, l: Single;
