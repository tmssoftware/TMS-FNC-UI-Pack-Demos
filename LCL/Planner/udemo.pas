...
uses
  ...
  StdCtrls, LCLTMSFNCBitmapContainer, LCLTMSFNCPlanner, LCLTMSFNCPlannerData, LCLTMSFNCPlannerBase,
  LCLTMSFNCGraphics, LCLTMSFNCGraphicsTypes, LCLTMSFNCTypes, DateUtils, Math;
...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure TMSFNCPlanner1BeforeDrawPosition(Sender: TObject;
      ...
      AKind: TTMSFNCPlannerCacheItemKind; var AAllow: Boolean;
...
begin
  ...
  TMSFNCPlanner1.BorderSpacing.Left := 10;
  TMSFNCPlanner1.BorderSpacing.Bottom := 10;
  ...
  Label1.BorderSpacing.Bottom := 10;
  Label1.BorderSpacing.Right := 10;
  Label1.BorderSpacing.Top := 10;
...
procedure TForm1.ChangeDisplayUnit;
begin
...
procedure TForm1.DrawCustomPositionText(AGraphics: TTMSFNCGraphics; APosition: Integer);
begin
...
procedure TForm1.TMSFNCPlanner1BeforeDrawGroupText(Sender: TObject;
  AGraphics: TTMSFNCGraphics; ARect: TRectF; AGroup, AStartPosition,
  AEndPosition: Integer; AKind: TTMSFNCPlannerCacheItemKind; AText: string;
  var AAllow: Boolean);
begin
...
procedure TForm1.TMSFNCPlanner1BeforeDrawPosition(Sender: TObject;
  AGraphics: TTMSFNCGraphics; ARect: TRectF; APosition: Integer;
...
procedure TForm1.TMSFNCPlanner1ItemAnchorClick(Sender: TObject;
  AItem: TTMSFNCPlannerItem; AAnchor: string);
begin
  ShowMessage(AAnchor);
end;
