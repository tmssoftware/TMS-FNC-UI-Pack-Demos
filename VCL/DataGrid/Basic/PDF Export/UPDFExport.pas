...
uses
  ...
  VCL.TMSFNCUtils, VCL.TMSFNCPDFIO, VCL.TMSFNCDataGridPDFIO,
  ...
  VCL.TMSFNCDataGrid, VCL.TMSFNCDataGridCell, VCL.TMSFNCGraphics,
  VCL.TMSFNCGraphicsTypes, VCL.TMSFNCDataGridBase, VCL.TMSFNCDataGridCore,
