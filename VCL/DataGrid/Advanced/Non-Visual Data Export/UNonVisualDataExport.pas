...
uses
  ...
  VCL.TMSFNCCustomControl, VCL.TMSFNCPDFIO,
  VCL.TMSFNCDataGridData, VCL.TMSFNCDataGridRenderer, VCL.TMSFNCDataGridExcelIO,
  VCL.TMSFNCCustomComponent, VCL.TMSFNCDataGridPDFIO;
