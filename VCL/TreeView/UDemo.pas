...
uses
  ...
  VCL.TMSFNCGraphics, VCL.TMSFNCGraphicsTypes, Types;
...
begin
  ...
  begin
    TMSFNCTreeView1.Columns[I].Filtering.Enabled := CheckBox5.Checked;
    TMSFNCTreeView1.Columns[I].Filtering.ButtonSize := TMSFNCTreeView1.ScalePaintValue(15);
    TMSFNCTreeView1.Columns[I].Filtering.DropDownWidth := TMSFNCTreeView1.ScalePaintValue(100);
    TMSFNCTreeView1.Columns[I].Filtering.DropDownHeight := TMSFNCTreeView1.ScalePaintValue(120);
  end;
...
procedure TForm130.CheckBox6Click(Sender: TObject);
var
  I: Integer;
begin
...
begin
  ...
  c.Text := 'Item';
  c.Width := TMSFNCTreeView1.ScalePaintValue(120);

  c := TMSFNCTreeView1.Columns.Add;
  c.Text := 'Description';
  c.WordWrapping := True;
  c.Width := TMSFNCTreeView1.ScalePaintValue(275);

  c := TMSFNCTreeView1.Columns.Add;
  c.Text := 'Price';
  c.HorizontalTextAlign := gtaTrailing;
  c.Width := TMSFNCTreeView1.ScalePaintValue(60);
  ...
  c := TMSFNCTreeView1.Columns.Add;
  c.Text := 'Stock';
  c.Width := TMSFNCTreeView1.ScalePaintValue(150);

  c := TMSFNCTreeView1.Columns.Add;
  c.Text := 'Amount';
  c.EditorType := tcetEdit;
  c.Width := TMSFNCTreeView1.ScalePaintValue(100);
  ...
  c.Width := TMSFNCTreeView1.ScalePaintValue(200);
