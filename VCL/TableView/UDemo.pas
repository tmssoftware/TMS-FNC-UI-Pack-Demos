...
uses
  ...
  VCL.TMSFNCTableView, Vcl.ExtCtrls, VCL.TMSFNCImage, VCL.TMSFNCHTMLText,
  Vcl.StdCtrls;
...
begin
  ...
  TMSFNCTableView1.ItemAppearance.HTMLTemplate := '<b><#NAME></b><br/><br/><font size="14" color="gcGray"><#DESCRIPTION></font>';
...
procedure TForm5.TMSFNCTableView1BeforeItemShowDetailControl(Sender: TObject;
...
procedure TForm5.TMSFNCTableView1ItemMoreOptionClick(Sender: TObject;
  AItem: TTMSFNCTableViewItem; AMoreOption: TTMSFNCTableViewMoreOption);
begin
...
procedure TForm5.TMSFNCTableView1ItemSelectionChanged(Sender: TObject);
begin
